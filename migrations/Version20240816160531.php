...
final class Version20240816160531 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Creates the ticket table and its sequence.';
    }
...
//         $this->addSql('DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_class WHERE relname = \'IDX_97A0ADA3E48FD905\') THEN CREATE INDEX IDX_97A0ADA3E48FD905 ON ticket (game_id); END IF; END $$;');
//         $this->addSql('DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM pg_class WHERE relname = \'IDX_97A0ADA36C755722\') THEN CREATE INDEX IDX_97A0ADA36C755722 ON ticket (buyer_id); END IF; END $$;');
